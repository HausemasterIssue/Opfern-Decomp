    ...
    public InputField(final String text) {
        ...
        this.addRenderListener((RenderListener)new RenderListener() {
            ...
            public void onPostRender() {
                ...
                final int[] real = GUI.calculateRealPosition((Component)InputField.this);
        ...
        this.addKeyListener(this.inputListener = (KeyListener)new KeyListener() {
            public void onKeyDown(final KeyListener.KeyEvent event) {
            ...
            public void onKeyUp(final KeyListener.KeyEvent event) {
